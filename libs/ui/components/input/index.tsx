...
const colorClasses = {
  ...
  error: {
    ...
    outline: 'bg-error-bg border-error focus:border-error-base', // per design: an error input always has a light pink background
  ...
  neutral: {
    solid:
      'bg-neutral-bg border-neutral text-neutral-text-primary focus:border-primary focus:shadow-focus-ring',
    outline:
